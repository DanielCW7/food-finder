            ...
            <div className="container mx-auto flex flex-col lg:flex-row">
                ...
                <div className="mx-auto flex items-center max-w-max">
                    <div className="block prose lg:prose-lg p-8 lg:p-12">
                        ...
                        This Colletor App was inspired by a sudden urge to dump out my entire box of comics onto the floor and try to take inventory of everything I had.
                        I found that keeping my comic book records on some list on my phone or written down on some random piece of paper was too tedious. Thus, the collector app was born!
                        With this app, it empowers the user with more control over their collections.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid gap-8 p-8 grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="lg:max-w-md transition-all border-2 border-primary p-10 rounded hover:bg-base-300 cursor-pointer">
