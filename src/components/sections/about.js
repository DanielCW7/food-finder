        ...
        <div className="bg-base-200 min-h-screen flex flex-col justify-center">
            <div className="container mx-auto flex flex-col">
                ...
                <div className="mx-auto flex items-center max-w-max">
                    <div className="text-center block prose lg:prose-lg p-8 lg:p-12">
                        <h2> How It Works: </h2>
                ...
                <div className="grid gap-2 p-8 grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="flex flex-col sm:flex-row transition-all rounded-xl lg:max-w-sm p-8 sm:p-10 cursor-pointer hover:bg-base-300 hover:-translate-y-1">
