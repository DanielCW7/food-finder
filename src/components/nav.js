...
const Nav = () => {
    ...
    return (
        <div>
            <div className="fixed top-0 left-0 right-0 bg-gray-900 text-white flex flex-col p-5 md:hidden z-50">
            ...
            <div className="hidden top-0 left-0 bottom-0 w-[200px] md:flex flex-col md:fixed bg-gray-900 text-white p-2 z-50">
                <ul className="flex flex-col py-2">
                    <Link className="border-l-4 border-l-gray-900 flex cursor-pointer px-0 py-2 hover:bg-gradient-to-r hover:from-green-700 hover:border-l-green-400" to={'/'}> 
                    ...
                    <Link className="border-l-4 border-l-gray-900 flex cursor-pointer px-0 py-2 hover:bg-gradient-to-r hover:from-green-700 hover:border-l-green-400" to={'/profile'}> 
                    ...
                    <Link className="border-l-4 border-l-gray-900 flex cursor-pointer px-0 py-2 hover:bg-gradient-to-r hover:from-green-700 hover:border-l-green-400" to={'/collection'}> 
                    ...
                    <Link className="border-l-4 border-l-gray-900 flex cursor-pointer px-0 py-2 hover:bg-gradient-to-r hover:from-green-700 hover:border-l-green-400" to={'/favorites'}> 
